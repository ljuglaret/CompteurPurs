...
(function($PS) {
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  var PasDeSaisie = (function () {
      function PasDeSaisie() {

      };
      PasDeSaisie.value = new PasDeSaisie();
      return PasDeSaisie;
  })();
  var SaisieIncorrecte = (function () {
      function SaisieIncorrecte() {

      };
      SaisieIncorrecte.value = new SaisieIncorrecte();
      return SaisieIncorrecte;
  })();
  var ChoisitValeur = (function () {
      function ChoisitValeur(value0) {
          this.value0 = value0;
      };
      ChoisitValeur.create = function (value0) {
          return new ChoisitValeur(value0);
      };
      return ChoisitValeur;
  })();
  var PasseDeLaccueilAuCompteur = (function () {
      function PasseDeLaccueilAuCompteur() {

      };
      PasseDeLaccueilAuCompteur.value = new PasseDeLaccueilAuCompteur();
      return PasseDeLaccueilAuCompteur;
  })();
  var Augmente = (function () {
      function Augmente() {

      };
      Augmente.value = new Augmente();
      return Augmente;
  })();
  var Diminue = (function () {
      function Diminue() {

      };
      Diminue.value = new Diminue();
      return Diminue;
  })();
  var Recommencer = (function () {
      ...
      Recommencer.value = new Recommencer();
      return Recommencer;
  })();
  var Accueil = (function () {
      function Accueil(value0) {
          this.value0 = value0;
      };
      Accueil.create = function (value0) {
          return new Accueil(value0);
      };
      return Accueil;
  })();
  var Compteur = (function () {
      function Compteur(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Compteur.create = function (value0) {
          return function (value1) {
              return new Compteur(value0, value1);
          };
      };
      return Compteur;
  })();
  var renderNextButton = function (action) {
      return function (message) {
          if (action instanceof Data_Either.Left) {
              return Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(true) ])([ Halogen_HTML_Core.text(message) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Core.text(action.value0) ]);
          };
          ...
          throw new Error("Failed pattern match at Button (line 82, column 5 - line 84, column 107): " + [ action.constructor.name ]);
      };
  };
  var view = function (v) {
      if (v.stage instanceof Accueil) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Compteur version 2") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput(function (str) {
              ...
              if (v.stage.value0 instanceof Data_Either.Right) {
                  return renderNextButton(new Data_Either.Right(PasseDeLaccueilAuCompteur.value))("suite");
              };
              if (v.stage.value0 instanceof Data_Either.Left && v.stage.value0.value0 instanceof PasDeSaisie) {
                  return renderNextButton(new Data_Either.Left("Entrez une valeur"))("suite");
              };
              if (v.stage.value0 instanceof Data_Either.Left && v.stage.value0.value0 instanceof SaisieIncorrecte) {
                  return renderNextButton(new Data_Either.Left("Entrez une valeure enti\xe8re"))("suite");
              };
              throw new Error("Failed pattern match at Button (line 57, column 7 - line 60, column 96): " + [ v.stage.value0.constructor.name ]);
          })() ]);
      };
      if (v.stage instanceof Compteur) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick((function () {
              var $47 = Data_Function["const"](Diminue.value);
              return function ($48) {
                  return Data_Maybe.Just.create($47($48));
              };
          })()) ])([ Halogen_HTML_Core.text("Diminue") ]), Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(v.stage.value0.compteur)), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick((function () {
              var $49 = Data_Function["const"](Augmente.value);
              return function ($50) {
                  return Data_Maybe.Just.create($49($50));
              };
          })()) ])([ Halogen_HTML_Core.text("Augmente") ]) ]), renderNextButton(new Data_Either.Right(Recommencer.value))("Recommencer") ]) ]);
      };
      throw new Error("Failed pattern match at Button (line 46, column 1 - line 46, column 52): " + [ v.constructor.name ]);
  };
  var initialState = {
      stage: new Accueil(new Data_Either.Left(PasDeSaisie.value))
  };
  var update = function (v) {
      if (v instanceof ChoisitValeur) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $22.stage = new Accueil(new Data_Either.Right(v1.value0));
                  return $22;
              });
          };
          if (v1 instanceof Data_Maybe.Nothing) {
              ...
              if ($26) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $27.stage = new Accueil(new Data_Either.Left(PasDeSaisie.value));
                      return $27;
                  });
              };
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $30.stage = new Accueil(new Data_Either.Left(SaisieIncorrecte.value));
                  return $30;
              });
          };
          throw new Error("Failed pattern match at Button (line 91, column 7 - line 96, column 72): " + [ v1.constructor.name ]);
      };
      if (v instanceof PasseDeLaccueilAuCompteur) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (etat) {
              if (etat.stage instanceof Accueil) {
                  if (etat.stage.value0 instanceof Data_Either.Right) {
                      return {
                          stage: new Compteur({
                              compteur: 0
                          }, etat.stage.value0.value0)
                      };
                  };
                  return initialState;
              };
      ...
      if (v instanceof Augmente) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (etat) {
              if (etat.stage instanceof Compteur) {
                  return {
                      stage: new Compteur({
                          compteur: etat.stage.value0.compteur + etat.stage.value1 | 0
                      }, etat.stage.value1)
                  };
              };
              return etat;
      ...
      throw new Error("Failed pattern match at Button (line 88, column 1 - line 88, column 63): " + [ v.constructor.name ]);
  };
