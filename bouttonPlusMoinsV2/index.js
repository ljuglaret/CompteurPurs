...
(function($PS) {
  ...
  var view = function (v) {
      ...
      throw new Error("Failed pattern match at Button (line 47, column 1 - line 47, column 52): " + [ v.constructor.name ]);
  };
  var initialState = {
  ...
  var update = function (v) {
      if (v instanceof ChoisitValeur) {
          var v1 = Data_Int.fromString(Data_String_Common.trim(v.value0));
          if (v1 instanceof Data_Maybe.Just) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              var $26 = Data_String_Common.trim(v.value0) === "";
              if ($26) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $27 = {};
                      for (var $28 in v2) {
