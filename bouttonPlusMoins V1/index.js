...
(function($PS) {
  ...
  var view = function (model) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Compteur version 1 ") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick((function () {
          var $3 = Data_Function["const"](Diminue.value);
          return function ($4) {
              return Data_Maybe.Just.create($3($4));
          };
      })()) ])([ Halogen_HTML_Core.text("Diminue") ]), Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(model.compteur)), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick((function () {
          var $5 = Data_Function["const"](Augmente.value);
          return function ($6) {
              return Data_Maybe.Just.create($5($6));
          };
      })()) ])([ Halogen_HTML_Core.text("Augmente") ]) ]);
  };
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Button (line 31, column 1 - line 31, column 63): " + [ v.constructor.name ]);
  };
